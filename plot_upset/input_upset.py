...
def create_group_upset_encode(df, out_f):
    ...
    #unique
    df['groupsAll'] = np.where(((df['Merged-valid-sample_ENC'].astype(str) == '11111') & (df['Merged-venn_ENC'] == 'ttttt')) | 
...
def create_col_to_venn(df): #create encode col as well
    ...
    df['Merged-venn_ENC'] = df['Geo-venn'] + df['Ngs-venn'] + df['CA-venn'] + df['Cistrome-venn'] + df['ENCODE-venn']
